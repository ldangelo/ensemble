<!-- Generated by ensemble-pi generator v1.0.0 | Source: refine-prd.yaml -->
<!-- Command: ensemble:refine-prd | Version: 2.3.0 -->
...
**Actions:**
1. Read the PRD file from the path provided in $ARGUMENTS
...
**Actions:**
1. Check frontmatter for an existing Readiness Score from a previous create-prd or refine-prd run
...
7. Update the Readiness Score in the PRD frontmatter
...
3. Add changelog entry at the bottom of the PRD: date, version, list of changes made during this refinement
4. Save the updated PRD to the same file path (overwrite the original)
5. Print summary: number of changes made, new version, updated readiness score and delta (if applicable)
