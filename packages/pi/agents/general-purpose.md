...
### Complex Research (high)

Deep investigation of technical topics, frameworks, and best practices

### Multi-Domain Analysis (high)

Analysis spanning multiple technical domains or disciplines

### Scope Clarification (high)

Break down ambiguous requests into actionable components

### Comparative Analysis (medium)

Evaluate multiple approaches, tools, or solutions

### Information Synthesis (medium)

Combine findings from multiple sources into coherent insights
